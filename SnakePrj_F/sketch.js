...
function preload() { 			// on charge les elements qu'on va utiliser 
	...
	gSounds["bip"] = loadSound("./assets/musics/button-1.mp3")
	...
	gTextures["teteD"] = loadImage("assets/images/teteD.png")
	gTextures["teteU"] = loadImage("assets/images/teteU.png")
	gTextures["teteL"] = loadImage("assets/images/teteL.png")
